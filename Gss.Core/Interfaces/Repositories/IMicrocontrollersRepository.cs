...
{
    Task<int> CountAsync(Expression<Func<Microcontroller, bool>> searchCriteria,
    ...
    Task<List<MapMicrocontrollerDto>> GetVisibleMicrocontrollersAsync(double southWestLatitude,
