    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
      ...
      migrationBuilder.CreateTable(
          ...
          columns: table => new
          {
            ...
            LastResponseTime = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true),
            Public = table.Column<bool>(type: "bit", nullable: false),
            Latitude = table.Column<double>(type: "float", nullable: true),
            Longitude = table.Column<double>(type: "float", nullable: true),
            PasswordHash = table.Column<string>(type: "nvarchar(max)", nullable: true),
            RequestedSensorID = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
      ...
      migrationBuilder.CreateTable(
          ...
          columns: table => new
          {
            MicrocontrollerID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            SensorID = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ValueReadTime = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
            SensorValue = table.Column<int>(type: "int", nullable: false),
            ValueReceivedTime = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false)
          },
          constraints: table =>
          {
